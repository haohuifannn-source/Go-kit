...
func (x *SumResponse) GetVal() int64 {
	if x != nil {
		return x.Val
	}
	return 0
...
func (x *ConcatResponse) GetVal() string {
	if x != nil {
		return x.Val
	}
	return ""
...
const file_addsrv_proto_rawDesc = "" +
	...
	"\x06Concat\x12\x11.pb.ConcatRequest\x1a\x12.pb.ConcatResponse\"\x00B\vZ\taddsrv/pbb\x06proto3"
